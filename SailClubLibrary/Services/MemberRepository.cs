...
namespace SailClubLibrary.Services
{
    ...
    public class MemberRepository : IMemberRepository
    {
        ...
        private Dictionary<string, Member> _members;//mobilnr.
        #endregion
        ...
        public List<Member> FilterNameMembers(string filterCriteria)
        {
            List<Member> filteredMembers = new List<Member>();
            foreach(Member member in _members.Values)
            {
                if(member.FirstName.Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
